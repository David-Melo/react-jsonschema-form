  ...
  describe('<Form>', () => {
        ...
        const { getByText } = renderForm({
          ...
          children: (
            <Fragment>
              ...
              <button type="submit">My Another submit</button>
            </Fragment>
          )
        });

        expect(getByText('My Submit')).toBeInTheDOM();
        expect(getByText('My Another Submit')).toBeInTheDOM();
      });
    });
    ...
    describe('Custom field template', () => {
      ...
      it('should use the provided template for labels', () => {
        /**
         * I use data-testid because this label
         * doesn't have any related input tag.
         */
    ...
    describe('Custom submit buttons', () => {
      it('should submit the form when clicked', () => {
        ...
        fireEvent.click(getByText('My Submit'));
        fireEvent.click(getByText('My Another Submit'));
