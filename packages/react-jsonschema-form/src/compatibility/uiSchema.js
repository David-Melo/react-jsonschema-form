...
export default pack(({ renderForm, widgets }) => {
  ...
  describe('uiSchema', () => {
    ...
    describe('custom widget', () => {
      describe('root widget', () => {
        ...
        it('should render a root custom widget', () => {
          ...
          expect(node.querySelectorAll('.custom').length).toBe(1);
        });
      });

      // TODO: each works independently but together they doesn't work
      describe.skip('custom options', () => {
        ...
        it('should log warning when deprecated ui:widget: {component, options} api is used', () => {
          ...
          expect(global.console.warn).toHaveBeenCalledWith(
            expect.stringContaining('ui:widget object is deprecated')
          );
        });
      ...
      describe('enum fields native options', () => {
        ...
        it('should merge enumOptions with custom options', () => {
          const { node } = renderForm({ schema, uiSchema });
          expect(node.querySelectorAll('.custom option').length).toBe(2);
        });
      });
      ...
      describe('enum fields disabled options', () => {
        ...
        it('should have atleast one option disabled', () => {
          ...
          expect(node.querySelectorAll('option:disabled').length).toBe(
            disabledOptionsLen
          );
          expect(node.querySelectorAll('option:enabled').length).toBe(
    ...
    describe('custom template', () => {
      /**
       * SchemaField -> FieldTemplate (template)
       * fields -> template
       * widgets -> template
       */
      describe('ui:FieldTemplate', () => {
        it('should show the custom field template for SchemaField', () => {
          const CustomFieldTemplate = () => {
            return <div data-testid="custom">Test</div>;
          };
          const schema = { title: 'Foo', type: 'string' };
          const uiSchema = { 'ui:FieldTemplate': 'CustomFieldTemplate' };
          const templates = { CustomFieldTemplate };
          const { queryByTestId } = renderForm({ templates, schema, uiSchema });

          expect(queryByTestId('custom')).toBeInTheDOM();
        });
      });

      describe('ui:ArrayFieldTemplate', () => {
        it('should show the custom field template for ArrayField', () => {
          ...
          const uiSchema = { 'ui:ArrayFieldTemplate': 'CustomArrayTemplate' };
          const templates = { CustomArrayTemplate };
          const { queryByTestId } = renderForm({ templates, schema, uiSchema });
      ...
      describe('ui:ObjectFieldTemplate', () => {
        ...
        const uiSchema = { 'ui:ObjectFieldTemplate': 'CustomObjectTemplate' };
        const templates = { CustomObjectTemplate };
        const { queryByTestId } = renderForm({ templates, schema, uiSchema });
    ...
    describe('string', () => {
      ...
      describe('textarea', () => {
        ...
        it('should accept a uiSchema object', () => {
          ...
          expect(node.querySelectorAll('textarea').length).toBe(1);
        });
        ...
        it('should update state when text is updated', () => {
          ...
          expect(getState().formData).toEqual({ foo: 'b' });
        });
      ...
      describe('password', () => {
        ...
        it('should accept a uiSchema object', () => {
          ...
          expect(node.querySelectorAll('[type=password]').length).toBe(1);
        });
      ...
      describe('color', () => {
        ...
        it('should accept a uiSchema object', () => {
          ...
          expect(node.querySelectorAll('[type=color]').length).toBe(1);
        });
        ...
        it('should update state when text is updated', () => {
          ...
          expect(getState().formData).toEqual({ foo: '#001122' });
        });
      });
      ...
      describe('hidden', () => {
        ...
        it('should accept a uiSchema object', () => {
          ...
          expect(node.querySelectorAll('[type=hidden]').length).toBe(1);
        });
        ...
        it('should map widget value to a typed state one', () => {
          ...
          expect(getState().formData.foo).toEqual('a');
        });
      });
    });
    ...
    describe('string (enum)', () => {
      ...
      describe('radio', () => {
        ...
        it('should accept a uiSchema object', () => {
          ...
          expect(node.querySelectorAll('[type=radio]').length).toBe(2);
        });
        ...
        it('should support formData', () => {
          ...
          expect(node.querySelectorAll('[type=radio]')[1].checked).toEqual(
            true
          );
        });
    ...
    describe('number', () => {
      ...
      describe('updown', () => {
        ...
        it('should accept a uiSchema object', () => {
          ...
          expect(node.querySelectorAll('[type=number]').length).toBe(1);
        });
        ...
        it('should update state when value is updated', () => {
          ...
          expect(getState().formData).toEqual({ foo: 6.28 });
        });
      ...
      describe('range', () => {
        ...
        it('should accept a uiSchema object', () => {
          ...
          expect(node.querySelectorAll('[type=range]').length).toBe(1);
        });
      ...
      describe('radio', () => {
        ...
        it('should accept a uiSchema object', () => {
          ...
          expect(node.querySelectorAll('[type=radio]').length).toBe(3);
        });
        ...
        it('should update state when value is updated', () => {
          ...
          expect(getState().formData).toEqual({ foo: 1.4142 });
        });
      });
      ...
      describe('hidden', () => {
        ...
        it('should map widget value to a typed state one', () => {
          ...
          expect(getState().formData.foo).toEqual(42);
        });
      });
    });
    ...
    describe('integer', () => {
      ...
      describe('updown', () => {
        ...
        it('should update state when value is updated', () => {
          ...
          expect(getState().formData).toEqual({ foo: 6 });
        });
      });
      ...
      describe('radio', () => {
        ...
        it('should update state when value is updated', () => {
          ...
          expect(getState().formData).toEqual({ foo: 2 });
        });
      });
    ...
    describe('boolean', () => {
      ...
      describe('radio', () => {
        ...
        it('should update state when false is checked', () => {
          ...
          expect(getState().formData).toEqual({ foo: false });
        });
        ...
        it('should update state when true is checked', () => {
          ...
          expect(getState().formData).toEqual({ foo: true });
        });
      });
      ...
      describe('hidden', () => {
        ...
        it('should map widget value to a typed state one', () => {
          ...
          expect(getState().formData.foo).toEqual(true);
        });
      });
    });
      ...
      describe('Fields', () => {
        ...
        describe('ObjectField', () => {
          ...
          beforeEach(() => {
            ...
            let rendered = renderForm({ schema, uiSchema });
            node = rendered.node;
          });
