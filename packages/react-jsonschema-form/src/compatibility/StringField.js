...
import { toDateString, parseDateString, utcToLocal } from '../utils';
  ...
  describe('StringField', () => {
    ...
    describe('TextWidget', () => {
      ...
      it('should handle a change event', () => {
        ...
        expect(getState().formData).toEqual('yo');
      });
      ...
      it('should handle an empty string change event with custom ui:defaultValue', () => {
        ...
        expect(getState().formData).toEqual('default');
      });
    ...
    describe('SelectWidget', () => {
      ...
      it('should assign a default value', () => {
        ...
        expect(getState().formData).toEqual('bar');
      });
      ...
      it('should reflect the change into the form state', () => {
        ...
        expect(getState().formData).toEqual('foo');
      });
      ...
      it('should reflect undefined into form state if empty option selected', () => {
        ...
        expect(getState().formData).toBeUndefined();
      });
    ...
    describe('TextareaWidget', () => {
      ...
      it('should render a textarea field with rows', () => {
        ...
        expect(node.querySelector('textarea').getAttribute('rows')).toEqual(
          '20'
        );
      });
    });
    ...
    describe('DateTimeWidget', () => {
      it('should render an datetime-local field', () => {
        ...
        expect(
          node.querySelectorAll('.field [type=datetime-local]').length
        ).toBe(1);
      });
      ...
      it('should assign a default value', () => {
        ...
        expect(getState().formData).toEqual(datetime);
      });
    ...
    describe('DateWidget', () => {
      ...
      it('should render a date field', () => {
        ...
        expect(node.querySelectorAll('.field [type=date]').length).toBe(1);
      });
      ...
      it('should accept a valid entered date', () => {
        ...
        expect(getState().errors.length).toBe(0);
        expect(getState().formData).toEqual('2012-12-12');
      });
    ...
    describe('AltDateTimeWidget', () => {
      ...
      it('should render a datetime field', () => {
        ...
        expect(node.querySelectorAll('.field select').length).toBe(6);
      });
      ...
      it('should reflect the change into the dom', () => {
        ...
        expect(getState().formData).toEqual('2012-10-02T01:02:03.000Z');
      });
      ...
      describe('Action buttons', () => {
        it('should render action buttons', () => {
          ...
          const buttonLabels = [].map.call(
            node.querySelectorAll('li button.btn'),
            x => x.textContent
          );
        ...
        it('should set current date when pressing the Now button', () => {
          ...
          Simulate.click(node.querySelector('button.btn-now'));

          // Test that the two DATETIMEs are within 5 seconds of each other.
          const now = new Date().getTime();
          const timeDiff = now - new Date(getState().formData).getTime();
        ...
        it('should clear current date when pressing the Clear button', () => {
          ...
          Simulate.click(node.querySelector('button.btn-now'));
          Simulate.click(node.querySelector('button.btn-clear'));
    ...
    describe('AltDateWidget', () => {
      ...
      it('should render a date field', () => {
        ...
        expect(node.querySelectorAll('.field select').length).toBe(3);
      });
      ...
      it('should reflect the change into the dom', () => {
        ...
        expect(getState().formData).toEqual('2012-10-02');
      });
      ...
      it('should accept a valid date', () => {
        const { getState, rerender } = renderForm({
          schema: {
            type: 'string',
            format: 'date'
          },
      ...
      describe('Action buttons', () => {
        ...
        it('should set current date when pressing the Now button', () => {
          ...
          expect(getState().formData).toEqual(expected);
        });
    ...
    describe('EmailWidget', () => {
      it('should render an email field', () => {
        ...
        expect(node.querySelectorAll('.field [type=email]').length).toBe(1);
      });
      ...
      it('should assign a default value', () => {
        ...
        expect(getState().formData).toEqual(email);
      });
    ...
    describe('URLWidget', () => {
      it('should render an url field', () => {
        ...
        expect(node.querySelectorAll('.field [type=url]').length).toBe(1);
      });
      ...
      it('should assign a default value', () => {
        ...
        expect(getState().formData).toEqual(url);
      });
    ...
    describe('ColorWidget', () => {
      ...
      it('should render a color field', () => {
        ...
        expect(node.querySelectorAll('.field [type=color]').length).toBe(1);
      });
      ...
      it('should assign a default value', () => {
        ...
        expect(getState().formData).toEqual(color);
      });
    ...
    describe('FileWidget', () => {
      ...
      it('should render a color field', () => {
        ...
        expect(node.querySelectorAll('.field [type=file]').length).toBe(1);
      });
      ...
      it('should assign a default value', () => {
        ...
        expect(getState().formData).toEqual(initialValue);
      });

      // TODO: filereader
      it.skip('should reflect the change into the dom', () => {
