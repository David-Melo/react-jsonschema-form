...
export function getUiOptions(uiSchema) {
  ...
  return Object.keys(uiSchema).filter(function (key) {
    ...
    if (key === 'ui:widget' && isObject(value)) {
      ...
      return Object.assign({}, options, value.options || {}, {
    ...
    return Object.assign({}, options, _defineProperty({}, key.substring(3), value));
  }, {});
}
...
function withDependentProperties(schema, additionallyRequired) {
  ...
  return Object.assign({}, schema, { required: required });
}
...
function withExactlyOneSubschema(schema, definitions, formData, dependencyKey, oneOf) {
  ...
  var dependentSchema = Object.assign({}, subschema, { properties: dependentSubschema });
