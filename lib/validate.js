...
function createErrorHandler(formData) {
  ...
  if (isObject(formData)) {
    return Object.keys(formData).reduce(function (acc, key) {
      return Object.assign({}, acc, _defineProperty({}, key, createErrorHandler(formData[key])));
    }, handler);
  }
  if (Array.isArray(formData)) {
    return formData.reduce(function (acc, value, key) {
      return Object.assign({}, acc, _defineProperty({}, key, createErrorHandler(value)));
    }, handler);
  }
  return handler;
}
...
function unwrapErrorHandler(errorHandler) {
  return Object.keys(errorHandler).reduce(function (acc, key) {
    if (key === "addError") {
      ...
      return Object.assign({}, acc, _defineProperty({}, key, errorHandler[key]));
    }
    return Object.assign({}, acc, _defineProperty({}, key, unwrapErrorHandler(errorHandler[key])));
  }, {});
}
